...
curl -sI https://repo1.maven.org/maven2/ai/nrouter/nrouter-sdk-kotlin/2.2.1/nrouter-sdk-kotlin-2.2.1.pom \
  | head -1        # expect: HTTP/2 200

# 3. Then Android.
cd ../android
$EDITOR gradle.properties                # version=2.2.1
$EDITOR build.gradle.kts                 # api("ai.nrouter:nrouter-sdk-kotlin:2.2.1")
./gradlew build
./gradlew publish
```
